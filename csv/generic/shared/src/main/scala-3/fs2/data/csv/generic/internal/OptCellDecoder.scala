...
private[generic] sealed trait OptCellDecoder[T] {
  def apply(name: String, value: Option[String]): DecoderResult[T]
}

private[generic] object OptCellDecoder extends LowPrioOptCellDecoders {
...
private[generic] trait LowPrioOptCellDecoders {
