...
import fs2.data.csv.{CsvName, CsvRow, CsvRowDecoder, DecoderResult}
import shapeless._

private[generic] trait DerivedCsvRowDecoder[T] extends CsvRowDecoder[T, String]

private[generic] object DerivedCsvRowDecoder {
