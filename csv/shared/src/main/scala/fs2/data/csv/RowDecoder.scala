...
object RowDecoder extends ExportedRowDecoders {
  ...
  implicit val identityRowDecoder: RowDecoder[Row] = _.asRight

  implicit def RowDecoderInstances: MonadError[RowDecoder[*], DecoderError] with SemigroupK[RowDecoder[*]] =
