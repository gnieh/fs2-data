  ...
  private def parseItem[F[_]](ctx: ParserContext[F])(implicit
    ...
    requireOneByte(ctx) flatMap { case (ctx, result) =>
      result match {
        ...
        case Headers.Float32   => parseSimpleType(MsgpackItem.Float32)(4, ctx)
        case Headers.Float64   => parseSimpleType(MsgpackItem.Float64)(8, ctx)
        case Headers.Uint8     => parseSimpleType(MsgpackItem.UnsignedInt)(1, ctx)
        case Headers.Uint16    => parseSimpleType(MsgpackItem.UnsignedInt)(2, ctx)
        case Headers.Uint32    => parseSimpleType(MsgpackItem.UnsignedInt)(4, ctx)
        case Headers.Uint64    => parseSimpleType(MsgpackItem.UnsignedInt)(8, ctx)
        case Headers.Int8      => parseSimpleType(MsgpackItem.SignedInt)(1, ctx)
        case Headers.Int16     => parseSimpleType(MsgpackItem.SignedInt)(2, ctx)
        case Headers.Int32     => parseSimpleType(MsgpackItem.SignedInt)(4, ctx)
        case Headers.Int64     => parseSimpleType(MsgpackItem.SignedInt)(8, ctx)
